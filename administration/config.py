...
SPORTS_EDGE_MIN            = 0.08  # In-game LONG edge threshold (edge-only tier)
...
SPORTS_PREGAME_CONFIDENCE_EDGE   = 0.01  # Edge floor for confidence-tier trades (model just needs to beat Kalshi)
